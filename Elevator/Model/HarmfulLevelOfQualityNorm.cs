...
{
    public class HarmfulLevelOfQualityNorm : AbstractLevelOfQualityNorm
    {
        ...
        public HarmfulLevelOfQualityNorm(string typeImp, string norm, string id) : base(typeImp, norm, id)
        {
        }
    }
}
